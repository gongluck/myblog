...
![Reactor模型](https://github.com/gongluck/CVIP/blob/master/images/Reactor模型.png)
...
- Reactor模型有三个重要的组件：
  ...
  ​	![Reactor组件](https://github.com/gongluck/CVIP/blob/master/images/Reactor组件.png)
...
![log4cpp模块图](https://github.com/gongluck/CVIP/blob/master/images/log4cpp模块图.png)

- log4cpp有且只⼀个根Category，可以有多个⼦Category组成树型结构。

  ![log4cpp的appender种类](https://github.com/gongluck/CVIP/blob/master/images/log4cpp的appender种类.png)
