---
title: "算法与设计模式专栏"
date: 2020-11-30T20:35:46+08:00
draft: false
...
![排序比较](https://github.com/gongluck/CVIP/blob/master/images/排序比较.png?raw=true)
...
- [代码](https://github.com/gongluck/CVIP/blob/master/code/sort/sort.c)
...
- [代码](https://github.com/gongluck/CVIP/blob/master/code/search/kmp.c)
...
- [代码](https://github.com/gongluck/CVIP/blob/master/code/tree/btree.c)
...
![红黑树](https://github.com/gongluck/CVIP/blob/master/images/红黑树.jpg?raw=true)
...
- [代码](https://github.com/gongluck/CVIP/blob/master/code/tree/rbtree.c)
...
![B树](https://github.com/gongluck/CVIP/blob/master/images/B树.png?raw=true)
...
- [代码](https://github.com/gongluck/CVIP/blob/master/code/tree/b-tree.c)
...
![布隆过滤器](https://github.com/gongluck/CVIP/blob/master/images/布隆过滤器.png?raw=true)
...
- [代码](https://github.com/gongluck/CVIP/blob/master/code/bloomfilter/bloomfilter.h)
...
![观察者模式](https://github.com/gongluck/CVIP/blob/master/images/观察者模式.png?raw=true)

- 定义对象间一种一对多的依赖关系，使得每当一个对象改变状态，则所有依赖于它的对象都会得到通知并被自动更新。

- [代码](https://github.com/gongluck/CVIP/blob/master/code/designpattern/observer.cpp)
...
![工厂模式](https://github.com/gongluck/CVIP/blob/master/images/工厂模式.png?raw=true)

- 定义一个用于创建对象的接口，让子类决定实例化哪一个类。工厂方法是一个类的实例化延迟到其子类。

- [代码](https://github.com/gongluck/CVIP/blob/master/code/designpattern/factory.cpp)
...
- [代码](https://github.com/gongluck/CVIP/blob/master/code/designpattern/singleton.cpp)
